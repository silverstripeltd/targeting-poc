...
{
    private static $db = [
        // Add "Group" here to enable functionality
        'ShowTo' => 'Enum(array("Everyone","LoggedOut","LoggedIn","Segments","Group","ByCountry"), "Everyone")',
        'Country' => 'Varchar(2)',
    ...
    /**
     * @var array This list would typically be retrieved by a third party such as segment.com
     * where segments are defined, and visitors are matched to segments based on what we know about them.
     * @config
     */
    ...
    {
        $useGroups = Config::inst()->get('Silverstripe\TargetingPoc\Config', 'use_groups');
        ...
        $useLoggedIn = Config::inst()->get('Silverstripe\TargetingPoc\Config', 'use_loggedin');
    ...
    {
        return $this->owner->config()->get('segments');
    }

    private function getCountriesList()
    {
        return $this->owner->config()->get('countries');
    }
}