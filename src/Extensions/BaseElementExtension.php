...
{
    private static $db = [
        'ShowTo' => 'Enum(array("Everyone","LoggedOut","LoggedIn","Group","ByCountry"), "Everyone")',
        'Country' => 'Varchar(2)'
    ];
    ...
    public function updateCMSFields(FieldList $fields)
    {
        ...
        $countryField = DropdownField::create('Country', 'Only show to these countries:', $this->getCountriesList())
            ->setHasEmptyDefault(true)
            ->setEmptyString('Please select')
            ->setDescription('This product includes GeoLite2 data created by MaxMind, available from <a href="http://www.maxmind.com">http://www.maxmind.com</a>.<br />If a country can\'t be found, we currently assume the country is NZ.');

        $fields->addFieldToTab('Root.Settings', $this->owner->dbObject('ShowTo')->scaffoldFormField()->setTitle('Show block to:'));
